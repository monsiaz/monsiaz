...
- **Automation & AI tools** — content pipelines, NLP post-processing, semantic classification, model benchmarking
...
- **AI / NLP** — LLM APIs · SBERT · Sentence Transformers · NLP pipelines
...
- **Content automation pipelines** — production pipelines generating and translating articles at scale, with NLP post-processing and internal link injection.
...
I believe the best SEOs are the ones who can build. I'm here to share tools, explore what's possible with automation and data, and collaborate with people who like to ship things that work.
